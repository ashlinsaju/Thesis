...
$I_{low}$ and $I_{high}$, respectively, are index breakpoints corresponds to $C_{low}$ and $C_{high}$.  The value of AQI varies from 0 to 500, which groups them into six main categories: 0-50 (good); 51-100 (satisfactory); 101-200 (moderate); 201-300 (poor); 301-400 (very poor); and 401-500 (severe).  
...
The value of AQHI varies from 1 to 10+, which again groups into four categories: 1-3 (low risk); 4-6 (moderate risk); 7-10 (high risk); and above 10 (very high risk). 
