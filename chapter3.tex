...
This kind of representation is very easy to understand the data and it shows the concentration that each pollutant adds to atmosphere. By using such a visualization, the user in the first category that is the common lay men, simply needs to read the data which will give a constant value for display.
